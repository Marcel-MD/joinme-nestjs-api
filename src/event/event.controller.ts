import { Body, Controller, Delete, Get, Inject, Param, ParseIntPipe, Patch, Post, Put, UseGuards } from '@nestjs/common';
...
export class EventController {
    ...
    @ApiBearerAuth()
    @UseGuards(JwtAuthGuard)
    async update(@Body() input: UpdateEventDto, @Param('id', ParseIntPipe) id: number, @CurrentUser() user: User) {
